...
bucket = client.get_bucket("de-gcp-training-2021/Final_Assignment_Dataset/")
blob = bucket.get_blob("DE-2021-Batch1-GCP-Final-Assignment-Dataset.csv")
...
df.to_csv('DE-2021-Batch1-GCP-Final-Assignment-Dataset.csv')

df.drop_duplicates(subset=None, inplace=True)
df.to_csv(file_name_output, index=False)


df = pd.read_csv('DE-2021-Batch1-GCP-Final-Assignment-Dataset.csv')
